<div class="h-screen">
  <section class="bg-primary-300 h-full">
    <div class="flex flex-col items-center font-medium justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <div id="alertaExito" class="hidden flex items-center p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
      ...
      <a href="<?= base_url() ?>" class="flex items-center mb-6 text-2xl font-semibold text-primary-900">
      ...
      <div class="w-full bg-primary-100 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1 class="text-xl font-bold leading-tight tracking-tight text-primary-900 md:text-2xl">
            Inicia sesión en tu cuenta
          </h1>
          <form id="loginCliente" method="POST" class="space-y-4 md:space-y-6" action="">
            <div>
              <label for="email" class="block mb-2 text-sm font-medium text-primary-900">Email</label>
              <input type="email" name="email" id="email" class="bg-primary-50 border border-primary-300 text-primary-900 rounded-lg focus:ring-primary-600 placeholder-primary-400 focus:border-primary-600 block w-full p-2.5" placeholder="Correo electrónico" required="">
            </div>
            <div class="pb-3">
              <label for="password" class="block mb-2 text-sm font-medium text-primary-900">Contraseña</label>
              <input type="password" name="Contraseña" id="password" placeholder="••••••••" class="bg-primary-50 border border-primary-300 text-primary-900 rounded-lg placeholder-primary-400 focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required="">
            </div>
            <div class="flex hidden items-center justify-between">
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input id="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-primary-300 rounded bg-primary-50 text-primary-500 focus:ring-3 focus:ring-primary-300">
                </div>
                <div class="ml-3 text-sm">
                  <label for="remember" class="text-primary-500">Recuerdame</label>
                </div>
              </div>
              <a href="#" class="text-sm font-medium text-primary-600 hover:underline">¿Olvide mi contraseña?</a>
            </div>
            <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Inicia sesión</button>
            <p class="text-sm font-light text-primary-500">
              ¿No tienes una cuenta aún? <a href="<?= site_url('registro/') ?>" class="font-medium text-primary-600 hover:underline">Regístrate</a>
            </p>
          </form>
        </div>
      </div>
